...
class CrearVehiculo(LoginRequiredMixin, CreateView):
    ...
    fields = ['matricula', 'propietario', 'modelo', 'marca', 'cant_puertas', 'color', 'chasis', 'cliente', 'avatar', 'blog_post']
...
class EditarVehiculo(LoginRequiredMixin, UpdateView):
    ...
    fields = ['matricula', 'propietario', 'modelo', 'marca', 'cant_puertas', 'color', 'cliente', 'avatar', 'blog_post']    #
